		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_targetPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_targetPort_feature", "_UI_Event_type"),
				 DEVSPackage.Literals.EVENT__TARGET_PORT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DEVSPackage.Literals.EVENT__VALUE,
				 true,
				 false,
				 true,
				 null,
