...
public class BundleAdapterFactory extends AdapterFactoryImpl {
	...
	protected BundleSwitch<Adapter> modelSwitch =
		new BundleSwitch<Adapter>() {
			...
			@Override
			public Adapter caseProcess(ws.bundle.Process object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link ws.bundle.Bundle <em>Bundle</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ws.bundle.Process <em>Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
