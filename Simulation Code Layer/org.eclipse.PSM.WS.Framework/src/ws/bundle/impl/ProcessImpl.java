 ...
 * </p>
 * <ul>
 *   <li>{@link ws.bundle.impl.ProcessImpl#getID <em>ID</em>}</li>
 *   <li>{@link ws.bundle.impl.ProcessImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link ws.bundle.impl.ProcessImpl#getMiddleware <em>Middleware</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessImpl extends MinimalEObjectImpl.Container implements ws.bundle.Process {
	/**
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case BundlePackage.PROCESS___RECEIVE:
				receive();
				return null;
		}
