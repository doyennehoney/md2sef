 ...
 * @generated
 */
public class MiddlewareSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MiddlewarePackage.MIDDLEWARE: {
				Middleware middleware = (Middleware)theEObject;
				T result = caseMiddleware(middleware);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MiddlewarePackage.WEB_SERVICE: {
				WebService webService = (WebService)theEObject;
				T result = caseWebService(webService);
				if (result == null) result = caseMiddleware(webService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MiddlewarePackage.VM: {
				VM vm = (VM)theEObject;
				T result = caseVM(vm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MiddlewarePackage.PROCESSOR: {
				Processor processor = (Processor)theEObject;
				T result = caseProcessor(processor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MiddlewarePackage.SERVICE_IMPL: {
				ServiceImpl serviceImpl = (ServiceImpl)theEObject;
				T result = caseServiceImpl(serviceImpl);
				if (result == null) result = caseServiceDescription(serviceImpl);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MiddlewarePackage.STUB: {
				Stub stub = (Stub)theEObject;
				T result = caseStub(stub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MiddlewarePackage.REPOSITORY: {
				Repository repository = (Repository)theEObject;
				T result = caseRepository(repository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MiddlewarePackage.SERVICE_DESCRIPTION: {
