...
/**
 * This is the item provider adapter for a {@link ws.bundle.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMiddlewarePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BundlePackage.Literals.PROCESS__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BundlePackage.Literals.PROCESS__NODES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Middleware feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMiddlewarePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_middleware_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_middleware_feature", "_UI_Process_type"),
				 BundlePackage.Literals.PROCESS__MIDDLEWARE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((ws.bundle.Process)object).getID();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ws.bundle.Process.class)) {
