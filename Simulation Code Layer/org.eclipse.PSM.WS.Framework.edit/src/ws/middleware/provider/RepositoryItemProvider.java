...
/**
 * This is the item provider adapter for a {@link ws.middleware.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MiddlewarePackage.Literals.REPOSITORY__SERVICES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Repository.class)) {
			case MiddlewarePackage.REPOSITORY__SERVICES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MiddlewarePackage.Literals.REPOSITORY__SERVICES,
				 MiddlewareFactory.eINSTANCE.createServiceImpl()));
	}
