...
/**
 * This is the item provider adapter for a {@link ws.middleware.Processor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MiddlewarePackage.Literals.PROCESSOR__ID,
				 true,
				 false,
				 false,
	...
	protected void addIPPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_IP_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_IP_feature", "_UI_Processor_type"),
				 MiddlewarePackage.Literals.PROCESSOR__IP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
