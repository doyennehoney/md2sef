...
/**
 * This is the item provider adapter for a {@link rsgf.bundle.Bundle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BundleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BundlePackage.Literals.BUNDLE__ID,
				 true,
				 false,
				 false,
	...
	protected void addSkeletonPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bundle_skeleton_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bundle_skeleton_feature", "_UI_Bundle_type"),
				 BundlePackage.Literals.BUNDLE__SKELETON,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BundlePackage.Literals.BUNDLE__PROCESS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BundlePackage.Literals.BUNDLE__PROCESS,
				 BundleFactory.eINSTANCE.createProcess()));
	}
