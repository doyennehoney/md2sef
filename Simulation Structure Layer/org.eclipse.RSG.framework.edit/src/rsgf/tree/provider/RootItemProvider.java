...
/**
 * This is the item provider adapter for a {@link rsgf.tree.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider extends NodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Root_child_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Root_child_feature", "_UI_Root_type"),
				 TreePackage.Literals.ROOT__CHILD,
				 true,
				 false,
				 true,
				 null,
