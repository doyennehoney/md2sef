...
/**
 * This is the item provider adapter for a {@link rsgf.tree.BasicNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BasicNodeItemProvider extends NodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BasicNode_modelName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BasicNode_modelName_feature", "_UI_BasicNode_type"),
				 TreePackage.Literals.BASIC_NODE__MODEL_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((BasicNode)object).getID();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BasicNode.class)) {
			case TreePackage.BASIC_NODE__MODEL_NAME:
