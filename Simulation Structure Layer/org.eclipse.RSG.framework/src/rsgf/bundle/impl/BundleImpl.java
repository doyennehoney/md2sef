 ...
 * </p>
 * <ul>
 *   <li>{@link rsgf.bundle.impl.BundleImpl#getID <em>ID</em>}</li>
 *   <li>{@link rsgf.bundle.impl.BundleImpl#getSkeleton <em>Skeleton</em>}</li>
 *   <li>{@link rsgf.bundle.impl.BundleImpl#getProcess <em>Process</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BundleImpl extends MinimalEObjectImpl.Container implements Bundle {
	...
	public EList<rsgf.bundle.Process> getProcess() {
		if (process == null) {
			process = new EObjectContainmentEList<rsgf.bundle.Process>(rsgf.bundle.Process.class, this, BundlePackage.BUNDLE__PROCESS);
		}
		return process;
	}
